...
import com.monglepick.monglepickbackend.domain.auth.dto.RefreshRequestDTO;
...
public class JWTService {
    ...
    public JWTResponseDTO cookie2Header(
        ...
        // 토큰 생성
        String newAccessToken = JWTUtil.createJWT(userEmail, true);
        String newRefreshToken = JWTUtil.createJWT(userEmail, false);
        ...
        return new JWTResponseDTO(newAccessToken, newRefreshToken, userNickname);
    }
